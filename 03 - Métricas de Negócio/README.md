...
Definir métricas de negócio uma única vez (governadas no Unity Catalog) e reutilizá-las em SQL, dashboards e na Genie. É o primeiro exercício em que você cria objetos no seu próprio schema.
...
Agora que suas metric views existem, compare as duas formas de calcular a mesma métrica, a inadimplência por segmento. Dão o mesmo número, com esforço e risco bem diferentes.
