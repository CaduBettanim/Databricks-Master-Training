...
- **[Ex. 6 - Multi-Agent](../06%20-%20An%C3%A1lise%20de%20Dados%20Multi-Agent)** — seu **Supervisor** publicado (o endpoint `mas-...-endpoint`).
- **[Ex. 7 - Previsão de Churn](../07%20-%20Previs%C3%A3o%20de%20Churn%20%28ML%29)** — a tabela `churn_scores`.
...
|-----|-----------|-------------|
| **📊 Cockpit** | KPIs de churn, um **mapa do Brasil** com o risco por região e 4 gráficos que **filtram ao clicar numa região**. Cada gráfico tem um botão **✨ Explicar** que pede uma leitura à IA. | `churn_scores` (Ex. 7) + base `churn`, lidos por um SQL Warehouse |
